...
{s_mission_params set [_foreachindex,_x]} foreach s_mission_params_vert;
...
s_missionsgenerierungen = s_vert_missionsgenerierungen_max +0;
[_remoteexecutedowner] execvm "alex_missions\verteidigung\s_mission_parameter_an_spieler.sqf";
