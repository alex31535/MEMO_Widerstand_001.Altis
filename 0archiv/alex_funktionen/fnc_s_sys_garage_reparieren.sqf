...
_fzg setDamage [0, true];
[[format["<t color='#00ff40' size='2'>%1: Erfolgreich repariert!",_fzg_displayname], "PLAIN", -1, true, true]] remoteExec ["cutText",_spieler];
