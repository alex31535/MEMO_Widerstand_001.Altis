...
{s_mission_params set [_foreachindex,_x]} foreach s_mission_params_rettz;
...
[_remoteexecutedowner] execvm "alex_missions\rettung_z\s_mission_parameter_an_spieler.sqf";
