...
{s_mission_params set [_foreachindex,_x]} foreach s_mission_params_amongm;
...
s_missionsgenerierungen = s_rettz_missionsgenerierungen_max +0;
[_remoteexecutedowner] execvm "alex_missions\among_memo\s_mission_parameter_an_spieler.sqf";
