...
/*5*/_parameter pushback ["Dichte Landfahrzeug-Spawn",[["Sehr gering",1],["Gering",2],["Mittel",4],["Hoch",8],["Sehr hoch",12]],
  ...
  ["Mittel",5]];
/*6*/_parameter pushback ["Dichte Zombie-Spawn",[["Sehr gering",1],["Gering",2],["Mittel",4],["Hoch",8],["Sehr hoch",12]],
  "Je geringer der Wert, desto hoeher die WAHRSCHEINLICHKEIT, dass Zombies nur aus einer wenigen Richtungen anrueckt.",
  ["Mittel",5]];
/*7*/_parameter pushback ["Wahrscheinlichkeit Zombie",_100er,
  "Wahrscheinlichkeit auf Zombie-Spawn. ACHTUNG: Kann relativiert werden durch andere Wahrscheinlichkeiten!",
  ["50 %",50]];
/*8*/_parameter pushback ["Wahrscheinlichkeit Radfahrzeuge, Klein",_100er,
  "Wahrscheinlichkeit auf Radfahrzeuge-Spawn. ACHTUNG: Kann relativiert werden durch andere Wahrscheinlichkeiten!",
  ["50 %",50]];
/*9*/_parameter pushback ["Wahrscheinlichkeit Transportfahrzeuge",_100er,
  "Wahrscheinlichkeit auf Kettenfahrzeuge-Spawn. ACHTUNG: Kann relativiert werden durch andere Wahrscheinlichkeiten!",
  ["50 %",50]];
/*10*/_parameter pushback ["Spawn-Entfernung Zombies",[["Sehr weit",700],["Weit",600],["Mittel",500],["Nah",400],["Sehr nah",300]],
  "Gibt an wie schnell der Erstkontakt mit Zombies stattfindet. ACHTUNG: Je schneller der Erstkontakt, desto weniger Zeit bleibt um Vorbereitungen zu treffen (Minen, etc.)!",
  ["Mittel",500]];
  reverse _100er;
/*11*/_parameter pushback ["Spawnanteil Zombies",_100er,
  "Je hoeher der Anteil an Zobies ist, desto weniger (normale) Feind-KI!",
  ["50 %",50]];


// # auslesen gespeicherter werte -> achtung: diese werte enthalten nur DIE GEWAEHLTEN paranmeter, nicht die vollstaendige auswahl
private _parameter_inidbi = [s_vertZ_missionskennung,[]] call fnc_s_sys_missionsparameter_inidbi;
