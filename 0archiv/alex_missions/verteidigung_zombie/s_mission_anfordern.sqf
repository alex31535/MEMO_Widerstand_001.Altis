...
{s_mission_params set [_foreachindex,_x]} foreach s_mission_params_vertZ;
...
s_missionsgenerierungen = s_vertZ_missionsgenerierungen_max +0;
[_remoteexecutedowner] execvm "alex_missions\verteidigung_zombie\s_mission_parameter_an_spieler.sqf";
